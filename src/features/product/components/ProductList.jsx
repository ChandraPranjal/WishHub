...
import { fetchFilterAsync } from "../../filters/filterSlice";
...
const filters = [
  {
    ...
    options: [
      ...
      { value: "New Arrivals", label: "smartphones", checked: false },
      { value: "New Arrivals", label: "laptops", checked: false },
      { value: "New Arrivals", label: "fragrances", checked: false },
      { value: "New Arrivals", label: "skincare", checked: false },
      { value: "New Arrivals", label: "groceries", checked: false },
      { value: "New Arrivals", label: "home decoration", checked: false },
      { value: "New Arrivals", label: "furniture", checked: false },
      { value: "New Arrivals", label: "tops", checked: false },
      { value: "New Arrivals", label: "womens dresses", checked: false },
      { value: "New Arrivals", label: "womens shoes", checked: false },
      { value: "New Arrivals", label: "mens shirts", checked: false },
      { value: "New Arrivals", label: "mens shoes", checked: false },
      { value: "New Arrivals", label: "mens watches", checked: false },
      { value: "New Arrivals", label: "womens watches", checked: false },
    ],
  },
  {
    id: "brand",
...
//Script to perform actions on data
...
export default function ProductList() {
  ...
  const categories = useSelector(
    (state) =>
      // console.log("state is " , state.filter.categories);
  ...
  const filterHandler = (e, section, option) => {
    ...
    if (e.target.checked === true) {
      ...
      const idx = newFilter[section.id].findIndex((el) => el === option.label);
                            ...
                            {section.options.map((option, optionIdx) => (
                              ...
                              >
                                <input
                                  ...
                                  onClick={() =>
                                    filterHandler(e, section, option)
                                  }
...
function Pagination({ currentPage, pageHandler, totalItems }) {
  return (
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
          ...
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">
              {currentPage === Math.ceil(totalItems / ITEMS_PER_PAGE)
                ? Math.max(totalItems % ITEMS_PER_PAGE, totalItems)
                : ITEMS_PER_PAGE * (currentPage - 1) + 10}
            </span>{" "}
        ...
        <div>
          ...
          >
            ...
            <div
              className={`${
                Math.ceil(totalItems / ITEMS_PER_PAGE) === currentPage
                  ? "hidden"
